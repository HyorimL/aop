...
public class MovieController {
	...
	public ResponseEntity<String> firstMovieNm(HttpServletResponse response,
			@RequestParam(required = false, defaultValue = "20220418") String targetDt) throws UnsupportedEncodingException {
		response.setContentType("text/html; charset=UTF-8");
		String nm = MovieApi.firstMovie(targetDt);
		System.out.println(nm);
		return new ResponseEntity<String>(nm, null, HttpStatus.OK); //한글 인코딩
	}
}
